;(function (window) {
  ...
  let texts = ['Click Anywhere :)','DONT FORGET', 'TO USE LANDSCAPE', 'HEY', 'SEE THIS', 'I WANT', 'TO TELL YOU ', 'SOMETHING', 'I WANT', 'TO LET YOU', 'KNOW THAT', 'I AM GRATEFULL', 'FOR BEING', 'YOUR FRIEND', 'I HOPE', 'THAT WE', 'ALWAYS BE FRIENDS', 'UNTILL THE END', 'OF MYSELF', 'AND', 'I WANT TO SAY THAT', 'I', 'LOVE', 'YOU ♡', 'THANK YOU', 'FOR', 'BEING IN MY LIFE', 'IM HAPPY I MET YOU THIS YEAR']
